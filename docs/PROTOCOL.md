...
| Foveated | gaze | 5 | 90 | Conventional: sharp at gaze, degraded periphery |
| InverseFoveated | gaze | 90 | 5 | Reversed: degraded at gaze, sharp periphery |

All three conditions are bandwidth-matched to Uniform Q50's average frame size (~13,154 bytes/frame) within ±5%.
...
Results from the matched-bandwidth sweep:

- **Baseline:** Uniform Q50 — avg 13,154 bytes/frame
- **Matched foveated condition:** periph_q=5, fovea_q=90 — within ±5% of baseline

Full sweep data: `docs/bench_results.csv`.
